...
CREATE TABLE `myapp_feedback` (
  ...
  PRIMARY KEY (`id`),
  KEY `myapp_feedback_recipe_id_ea6df190_fk_myapp_recipe_id` (`recipe_id`),
  KEY `myapp_feedback_user_id_1a72ee6f` (`user_id`),
  CONSTRAINT `myapp_feedback_recipe_id_ea6df190_fk_myapp_recipe_id` FOREIGN KEY (`recipe_id`) REFERENCES `myapp_recipe` (`id`)
